...
read_verilog -netlist /local-scratch/localhome/escmc38/Desktop/ensc450/fpu_double_backend/BE_045/PR_96density_tuned_16ns/results/verilog/fpu_double.final.v
# use ddc according to this http://www.vlsiip.com/power/
#read_ddc ../syn_045/results/fpu_double_backend.ddc
...
set VCDFILES {../sim/fpu_double_backend.vcd.saif}
...
#    report_power -analysis_effort high > ./results/power_analysis_55Mhz_vcd.rpt
    ...
    report_power -analysis_effort high -verbose -hierarchy > ./results_backend_16ns/power_analysis_62point5Mhz_vcd.rpt
}
